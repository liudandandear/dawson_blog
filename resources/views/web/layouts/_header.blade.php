    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="{{ active_class(if_route('frontend.topics.index')) }}"><a href="{{ route('frontend.topics.index') }}">最新 📣</a>
                </li>
                <li class="{{ active_class((if_route('frontend.categories.show') && if_route_param('category', 1))) }}"><a
                        href="{{ route('frontend.categories.show', 1) }}">分享 😋</a></li>
                <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 2))) }}"><a
                        href="{{ route('frontend.categories.show', 5) }}">面试 💯</a></li>
                <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 2))) }}"><a
                        href="{{ route('frontend.categories.show', 6) }}">笔记 📒</a></li>
{{--                <li class=""><a--}}
{{--                        href="{{ route('books.index') }}">面团小册 📚</a></li>--}}
            ...
            <ul class="nav navbar-nav navbar-right">
                @guest
                    <li><a href="{{ route('frontend.auth.login') }}">立即登录</a></li>
                    <li><a href="{{ route('frontend.auth.register') }}">注册</a></li>
                @else
                    <li role="fat-menu" class="dropdown">
                        ...
                        <ul id="menu2" class="dropdown-menu" aria-labelledby="drop5">
                            <li>
                                <a href="{{ route('frontend.topics.create') }}">✍️ 创建文章
                                    {{--                                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>--}}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('frontend.books.create') }}">📚 创建小册
                                    {{--                                    <span class="glyphicon glyphicon-books" aria-hidden="true"></span>--}}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('frontend.topics.create') }}">🚩 发起面团
                    ...
                    {{-- 消息通知标记 --}}
                    <li>
                        <a href="{{ route('frontend.notifications.index') }}" class="notifications-badge"
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            @can('manage_contents')
                                <li>
                                    <a href="{{ route('admin.auth.user.show', Auth::id()) }}">
                            ...
                            <li>
                                <a href="{{ route('admin.auth.user.edit', Auth::id()) }}">
