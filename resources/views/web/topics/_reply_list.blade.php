...
{{--                <a href="{{ route('frontend.users.show', [$reply->user_id]) }}">--}}
...
{{--                    <a href="{{ route('frontend.users.show', [$reply->user_id]) }}" title="{{ $reply->user->name }}">--}}
{{--                    {{ $reply->user->name }}--}}
{{--                    </a>--}}
{{--                    <span> •  </span>--}}
...
{{--                            <form action="{{ route('frontend.replies.destroy', $reply->id) }}" method="post">--}}
{{--                                {{ csrf_field() }}--}}
{{--                                {{ method_field('DELETE') }}--}}
