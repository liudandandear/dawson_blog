        ...
        @foreach ($topics as $topic)
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('admin.auth.user.show', [$topic->user_id]) }}">
                    <a href="">
                ...
                <div class="media-body">
                    ...
                    <div class="media-body meta">
                        ...
                        <a href="{{ route('frontend.categories.show', $topic->category->id) }}" title="{{ $topic->category->name }}">
                            <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                             {{ $topic->category->name }}
                        </a>

                        <span> • </span>
                        <a href="{{ route('admin.auth.user.show', [$topic->user_id]) }}" title="{{ $topic->user->name }}">
