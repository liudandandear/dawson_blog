            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    @if (if_query('tab', 'replies'))
                        ...
                        @include('web.topics.books._chapter', ['chapters' => $topic_has_book->topics_has_chapter()->paginate(5)])
                    @else
                        <ul class="nav nav-tabs">
                        ...
                        @include('web.topics.books._article', ['topics' => $book->chapter_has_books()->paginate(5)])
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="addChapter" tabindex="-1" role="dialog" aria-labelledby="addChapter">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('frontend.books.chapterAdd') }}" method="POST"
    ...
    <div class="modal fade" id="addTopic" tabindex="-1" role="dialog" aria-labelledby="addTopic">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('frontend.books.chapterHasTopic') }}" method="POST"
                    accept-charset="UTF-8"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
